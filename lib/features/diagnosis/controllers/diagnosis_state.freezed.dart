...
mixin _$DiagnosisState {
 ...
 Operation get op; String get statusMessage; String? get gender; String? get activityLevel; bool get isSmoker; bool get hasDiabetes; bool get hasHypertension; bool get isPregnant; bool? get isAlcoholic; String? get patientJob; String? get sessionId; Operation get searchOp; List<Symptom> get searchResults; List<Question> get currentQuestions; FollowUpResponse? get currentFollowUp; int get followUpProgress; int get followUpTotal; FinalReport? get finalReport; double get downloadProgress;
...
@override
int get hashCode => Object.hashAll([runtimeType,op,statusMessage,gender,activityLevel,isSmoker,hasDiabetes,hasHypertension,isPregnant,isAlcoholic,patientJob,sessionId,searchOp,const DeepCollectionEquality().hash(searchResults),const DeepCollectionEquality().hash(currentQuestions),currentFollowUp,followUpProgress,followUpTotal,finalReport,downloadProgress]);

@override
String toString() {
  return 'DiagnosisState(op: $op, statusMessage: $statusMessage, gender: $gender, activityLevel: $activityLevel, isSmoker: $isSmoker, hasDiabetes: $hasDiabetes, hasHypertension: $hasHypertension, isPregnant: $isPregnant, isAlcoholic: $isAlcoholic, patientJob: $patientJob, sessionId: $sessionId, searchOp: $searchOp, searchResults: $searchResults, currentQuestions: $currentQuestions, currentFollowUp: $currentFollowUp, followUpProgress: $followUpProgress, followUpTotal: $followUpTotal, finalReport: $finalReport, downloadProgress: $downloadProgress)';
}
...
@useResult
$Res call({
 Operation op, String statusMessage, String? gender, String? activityLevel, bool isSmoker, bool hasDiabetes, bool hasHypertension, bool isPregnant, bool? isAlcoholic, String? patientJob, String? sessionId, Operation searchOp, List<Symptom> searchResults, List<Question> currentQuestions, FollowUpResponse? currentFollowUp, int followUpProgress, int followUpTotal, FinalReport? finalReport, double downloadProgress
});
...
/// Create a copy of DiagnosisState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? op = null,Object? statusMessage = null,Object? gender = freezed,Object? activityLevel = freezed,Object? isSmoker = null,Object? hasDiabetes = null,Object? hasHypertension = null,Object? isPregnant = null,Object? isAlcoholic = freezed,Object? patientJob = freezed,Object? sessionId = freezed,Object? searchOp = null,Object? searchResults = null,Object? currentQuestions = null,Object? currentFollowUp = freezed,Object? followUpProgress = null,Object? followUpTotal = null,Object? finalReport = freezed,Object? downloadProgress = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Operation op,  String statusMessage,  String? gender,  String? activityLevel,  bool isSmoker,  bool hasDiabetes,  bool hasHypertension,  bool isPregnant,  bool? isAlcoholic,  String? patientJob,  String? sessionId,  Operation searchOp,  List<Symptom> searchResults,  List<Question> currentQuestions,  FollowUpResponse? currentFollowUp,  int followUpProgress,  int followUpTotal,  FinalReport? finalReport,  double downloadProgress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiagnosisState() when $default != null:
return $default(_that.op,_that.statusMessage,_that.gender,_that.activityLevel,_that.isSmoker,_that.hasDiabetes,_that.hasHypertension,_that.isPregnant,_that.isAlcoholic,_that.patientJob,_that.sessionId,_that.searchOp,_that.searchResults,_that.currentQuestions,_that.currentFollowUp,_that.followUpProgress,_that.followUpTotal,_that.finalReport,_that.downloadProgress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Operation op,  String statusMessage,  String? gender,  String? activityLevel,  bool isSmoker,  bool hasDiabetes,  bool hasHypertension,  bool isPregnant,  bool? isAlcoholic,  String? patientJob,  String? sessionId,  Operation searchOp,  List<Symptom> searchResults,  List<Question> currentQuestions,  FollowUpResponse? currentFollowUp,  int followUpProgress,  int followUpTotal,  FinalReport? finalReport,  double downloadProgress)  $default,) {final _that = this;
switch (_that) {
case _DiagnosisState():
return $default(_that.op,_that.statusMessage,_that.gender,_that.activityLevel,_that.isSmoker,_that.hasDiabetes,_that.hasHypertension,_that.isPregnant,_that.isAlcoholic,_that.patientJob,_that.sessionId,_that.searchOp,_that.searchResults,_that.currentQuestions,_that.currentFollowUp,_that.followUpProgress,_that.followUpTotal,_that.finalReport,_that.downloadProgress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Operation op,  String statusMessage,  String? gender,  String? activityLevel,  bool isSmoker,  bool hasDiabetes,  bool hasHypertension,  bool isPregnant,  bool? isAlcoholic,  String? patientJob,  String? sessionId,  Operation searchOp,  List<Symptom> searchResults,  List<Question> currentQuestions,  FollowUpResponse? currentFollowUp,  int followUpProgress,  int followUpTotal,  FinalReport? finalReport,  double downloadProgress)?  $default,) {final _that = this;
switch (_that) {
case _DiagnosisState() when $default != null:
return $default(_that.op,_that.statusMessage,_that.gender,_that.activityLevel,_that.isSmoker,_that.hasDiabetes,_that.hasHypertension,_that.isPregnant,_that.isAlcoholic,_that.patientJob,_that.sessionId,_that.searchOp,_that.searchResults,_that.currentQuestions,_that.currentFollowUp,_that.followUpProgress,_that.followUpTotal,_that.finalReport,_that.downloadProgress);case _:
  return null;
...
class _DiagnosisState implements DiagnosisState {
  const _DiagnosisState({this.op = Operation.neutral, this.statusMessage = "", this.gender, this.activityLevel, this.isSmoker = false, this.hasDiabetes = false, this.hasHypertension = false, this.isPregnant = false, this.isAlcoholic = false, this.patientJob = "", this.sessionId, this.searchOp = Operation.neutral,  List<Symptom> searchResults = const [],  List<Question> currentQuestions = const [], this.currentFollowUp, this.followUpProgress = 0, this.followUpTotal = 0, this.finalReport, this.downloadProgress = 0.0}): _searchResults = searchResults,_currentQuestions = currentQuestions;
...
@override
int get hashCode => Object.hashAll([runtimeType,op,statusMessage,gender,activityLevel,isSmoker,hasDiabetes,hasHypertension,isPregnant,isAlcoholic,patientJob,sessionId,searchOp,const DeepCollectionEquality().hash(_searchResults),const DeepCollectionEquality().hash(_currentQuestions),currentFollowUp,followUpProgress,followUpTotal,finalReport,downloadProgress]);
