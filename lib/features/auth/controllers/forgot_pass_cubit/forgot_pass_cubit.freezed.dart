...
mixin _$ForgotPassState {
 ...
 String get message; Operation get op;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgotPassState&&(identical(other.message, message) || other.message == message)&&(identical(other.op, op) || other.op == op));
}


@override
int get hashCode => Object.hash(runtimeType,message,op);

@override
String toString() {
  return 'ForgotPassState(message: $message, op: $op)';
}
...
/// Create a copy of ForgotPassState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? op = null,}) {
  return _then(ForgotPassState(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message,  Operation op)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPassState() when $default != null:
return $default(_that.message,_that.op);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message,  Operation op)  $default,) {final _that = this;
switch (_that) {
case _ForgotPassState():
return $default(_that.message,_that.op);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message,  Operation op)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPassState() when $default != null:
return $default(_that.message,_that.op);case _:
  return null;
...
class _ForgotPassState implements ForgotPassState {
  const _ForgotPassState({required this.message, required this.op});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ForgotPassState&&(identical(other.message, message) || other.message == message)&&(identical(other.op, op) || other.op == op));
}
...
/// Create a copy of ForgotPassState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? op = null,}) {
