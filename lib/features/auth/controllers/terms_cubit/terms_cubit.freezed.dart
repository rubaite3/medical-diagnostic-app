...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TermsState&&(identical(other.isChecked, isChecked) || other.isChecked == isChecked));
}
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'TermsState(isChecked: $isChecked)';
}
...
/// Create a copy of TermsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isChecked = null,}) {
  return _then(TermsState(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isChecked)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TermsState() when $default != null:
return $default(_that.isChecked);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isChecked)  $default,) {final _that = this;
switch (_that) {
case _TermsState():
return $default(_that.isChecked);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isChecked)?  $default,) {final _that = this;
switch (_that) {
case _TermsState() when $default != null:
return $default(_that.isChecked);case _:
  return null;
...
class _TermsState with DiagnosticableTreeMixin implements TermsState {
  const _TermsState({this.isChecked = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TermsState&&(identical(other.isChecked, isChecked) || other.isChecked == isChecked));
}
...
/// Create a copy of TermsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isChecked = null,}) {
