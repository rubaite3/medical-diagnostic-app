...
mixin _$RegisterRequest {
 ...
 String get name; String get email; String get password;@JsonKey(name: "password_confirmation") String get passwordConfirmation;
...
@useResult
$Res call({
 String name, String email, String password,@JsonKey(name: "password_confirmation") String passwordConfirmation
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String email,  String password, @JsonKey(name: "password_confirmation")  String passwordConfirmation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterRequest() when $default != null:
return $default(_that.name,_that.email,_that.password,_that.passwordConfirmation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String email,  String password, @JsonKey(name: "password_confirmation")  String passwordConfirmation)  $default,) {final _that = this;
switch (_that) {
case _RegisterRequest():
return $default(_that.name,_that.email,_that.password,_that.passwordConfirmation);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String email,  String password, @JsonKey(name: "password_confirmation")  String passwordConfirmation)?  $default,) {final _that = this;
switch (_that) {
case _RegisterRequest() when $default != null:
return $default(_that.name,_that.email,_that.password,_that.passwordConfirmation);case _:
  return null;
...
class _RegisterRequest implements RegisterRequest {
   _RegisterRequest({required this.name, required this.email, required this.password, @JsonKey(name: "password_confirmation") required this.passwordConfirmation});
