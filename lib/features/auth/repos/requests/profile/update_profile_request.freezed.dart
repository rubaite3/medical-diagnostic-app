...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,fullName,avatar,birthDate,gender,isSmoker,occupation,drinksAlcohol,hasDiabetes,hasHypertension,isPregnant,activityLevel,bloodType,lastCheckupDate);
...
as String?,drinksAlcohol: freezed == drinksAlcohol ? _self.drinksAlcohol : drinksAlcohol // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _UpdateProfileRequest() when $default != null:
return $default(_that.fullName,_that.avatar,_that.birthDate,_that.gender,_that.isSmoker,_that.occupation,_that.drinksAlcohol,_that.hasDiabetes,_that.hasHypertension,_that.isPregnant,_that.activityLevel,_that.bloodType,_that.lastCheckupDate);case _:
  return orElse();
...
switch (_that) {
case _UpdateProfileRequest():
return $default(_that.fullName,_that.avatar,_that.birthDate,_that.gender,_that.isSmoker,_that.occupation,_that.drinksAlcohol,_that.hasDiabetes,_that.hasHypertension,_that.isPregnant,_that.activityLevel,_that.bloodType,_that.lastCheckupDate);}
}
...
@override@JsonKey(includeIfNull: false, name: "drinks_alcohol") final  bool? drinksAlcohol;
...
@override@JsonKey(includeIfNull: false, name: "blood_type") final  String? bloodType;
